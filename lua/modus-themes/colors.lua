...
M.modus_operandi = {
	...
	-- yellow_faint = "#624416",
	yellow = "#eefa02",
	yellow_warmer =  "#eefa02",
	yellow_cooler =  "#eefa02",
	yellow_faint =  "#eefa02",
	...
	magenta_cooler ="#f202fa", -- "#fa02fa", -- "#870087", -- #ec00fc",
	magenta_faint = "#7c318f",
	-- cyan = "#005e8b",
	cyan = "#0000ff", -- "#0702fa", --  "#00008b",
	cyan_warmer = "#3f578f",
	-- cyan_cooler = "#005f5f",
	cyan_cooler = "#00ff00",
	cyan_faint = "#005077",
...
function M.setup(opts)
	...
	colors.comment = colors.fg_main -- colors.fg_dim
